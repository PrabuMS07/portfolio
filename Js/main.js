...
(function(html) {
   ...
   /* Update Footer Year
    * ------------------------------------------------------ */
   const ssUpdateFooterYear = function() {
    const copyrightSpan = document.querySelector('.ss-copyright span:first-child');
    if (copyrightSpan) {
        const currentYear = new Date().getFullYear();
        copyrightSpan.textContent = `© Copyright Prabu M S ${currentYear}`;
    }
}; // end ssUpdateFooterYear

// Add this line inside the ssInit function, maybe after ssMoveTo();
ssUpdateFooterYear();